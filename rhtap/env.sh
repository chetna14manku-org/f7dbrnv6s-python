...
export GITOPS_REPO_URL=https://github.com/chetna14manku-org/f7dbrnv6s-python-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.cluster-ht59c.ht59c.sandbox597.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.cluster-ht59c.ht59c.sandbox597.opentlc.com}
